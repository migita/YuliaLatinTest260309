const STORAGE_KEY = "latin-checklists-6-7-quiz-v1";
...
const CARDS = [
  word("checklist-6", "abest", "is out / is absent", {
    englishAnswers: ["is out", "is absent", "is out is absent"],
  }),
  word("checklist-6", "aberat", "was out / was absent", {
    englishAnswers: ["was out", "was absent", "was out was absent"],
  }),
  word("checklist-6", "cubiculum", "bedroom"),
  word("checklist-6", "emit", "buys"),
  word("checklist-6", "ferociter", "fiercely"),
  word("checklist-6", "festinat", "hurries"),
  word("checklist-6", "fortis", "brave"),
  word("checklist-6", "fur", "thief"),
  word("checklist-6", "intente", "intently / carefully", {
    englishAnswers: ["intently", "carefully", "intently carefully"],
  }),
  word("checklist-6", "libertus", "freedman / ex-slave", {
    englishAnswers: ["freedman", "ex-slave", "ex slave", "freedman ex slave"],
  }),
  word("checklist-6", "olim", "once / some time ago", {
    englishAnswers: ["once", "some time ago", "once some time ago"],
  }),
  word("checklist-6", "parvus", "small"),
  word("checklist-6", "per", "through"),
  word("checklist-6", "postquam", "when / after", {
    englishAnswers: ["when", "after", "when after"],
  }),
  word("checklist-6", "pulsat", "hits / thumps", {
    englishAnswers: ["hits", "thumps", "hits thumps"],
  }),
  word("checklist-6", "quod", "because"),
  word("checklist-6", "res", "thing"),
  word("checklist-6", "scribit", "writes"),
  word("checklist-6", "subito", "suddenly"),
  word("checklist-6", "superat", "overcomes / overpowers", {
    englishAnswers: ["overcomes", "overpowers", "overcomes overpowers"],
  }),
  word("checklist-6", "tum", "then"),
  word("checklist-6", "tuus", "your / yours", {
    englishAnswers: ["your", "yours", "your yours"],
  }),
  word("checklist-6", "vendit", "sells"),
  word("checklist-6", "vituperat", "blames / curses", {
    englishAnswers: ["blames", "curses", "blames curses"],
  }),
  pairWord("checklist-7", "cenat", "cenavit", "eats dinner / dines", {
    englishAnswers: ["eats dinner", "dines", "eats dinner dines"],
  }),
  pairWord("checklist-7", "conspicit", "conspexit", "catches sight of"),
  word("checklist-7", "cum", "with"),
  pairWord("checklist-7", "facit", "fecit", "makes / does", {
    englishAnswers: ["makes", "does", "makes does"],
  }),
  word("checklist-7", "heri", "yesterday"),
  word("checklist-7", "ingens", "huge"),
  pairWord("checklist-7", "intellegit", "intellexit", "understands"),
  pairWord("checklist-7", "lacrimat", "lacrimavit", "weeps / cries", {
    englishAnswers: ["weeps", "cries", "weeps cries"],
  }),
  word("checklist-7", "mortuus", "dead"),
  pairWord("checklist-7", "narrat", "narravit", "tells / relates", {
    englishAnswers: ["tells", "relates", "tells relates"],
  }),
  pairWord("checklist-7", "necat", "necavit", "kills"),
  word("checklist-7", "nihil", "nothing"),
  word("checklist-7", "omnis", "all"),
  pairWord("checklist-7", "parat", "paravit", "prepares"),
  word("checklist-7", "prope", "near"),
  pairWord("checklist-7", "rogat", "rogavit", "asks"),
  word("checklist-7", "tacite", "quietly"),
  word("checklist-7", "tamen", "however"),
  pairWord("checklist-7", "terret", "terruit", "frightens"),
  word("checklist-7", "valde", "very much / very", {
    englishAnswers: ["very much", "very", "very much very"],
  }),
];
...
function hintForQuestion(question) {
  ...
  if (question.direction === "en-la" && question.card.kind === "verb-pair") {
    hints.push("For checklist 7 verb pairs, the first Latin form on its own is accepted.");
  }
